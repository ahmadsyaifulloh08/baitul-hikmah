  ...
  return (
    ...
    <main className="min-h-screen bg-[var(--bg-primary)]">
      ...
      <article className="max-w-3xl mx-auto px-4 pt-6 pb-12">
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[var(--text-primary)] mt-8 mb-4">Metode Verifikasi Konten</h2>
          <div className="text-[var(--text-secondary)] space-y-4 leading-relaxed">
            <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[var(--text-primary)] mt-8 mb-4">Ilustrasi</h2>
          <div className="text-[var(--text-secondary)] space-y-4 leading-relaxed">
            <p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-[var(--text-primary)] mt-8 mb-4">Tim</h2>
          <div className="text-[var(--text-secondary)] space-y-4 leading-relaxed">
            <p>
