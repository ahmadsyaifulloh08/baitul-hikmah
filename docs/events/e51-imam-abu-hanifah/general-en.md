# Imam Abu Hanifah: Founder of the Hanafi School (699-767 CE)
...
Kufa at that time was an important center of Islamic learning, where many companions and successors gathered. The city founded by **Umar ibn al-Khattab** in 17 AH had developed into an intellectual metropolis with a population of over 120,000. The ethnic diversity of its inhabitants—Arabs, Persians, and various other tribes—created rich intellectual dynamics and deep legal discussions.^3

**Ibrahim al-Nakha'i** (d. 96 AH), one of Kufa's leading scholars, greatly influenced the scholarly tradition of the city. As a student of **Alqamah ibn Qays** and **al-Aswad ibn Yazid**—both companions of **Abdullah ibn Mas'ud**—Ibrahim inherited the flexible and rational legal approach characteristic of the Kufa school.^4

Young Abu Hanifah was exposed to various legal opinions that developed there. The Kufa textile market where his family traded became a meeting point for merchants from throughout the Islamic world, bringing diverse practical legal problems that required quick and flexible solutions. This cosmopolitan environment shaped Abu Hanifah's perspective on the need for law that could adapt to diverse social realities.^5

Initially, Abu Hanifah focused more on his family's silk and textile business. He was known as an honest and fair merchant, even refusing profit from transactions he doubted were lawful. This reputation would become the foundation of public trust in him later. Only around age 20, after meeting **Sha'bi al-Kufi** (d. 104 AH), did he begin seriously studying religious sciences.^6

## Intellectual Formation and Methodology

### Learning with Hammad ibn Abi Sulayman

**Hammad ibn Abi Sulayman** (d. 120 AH) became Abu Hanifah's main teacher in jurisprudence. Hammad was a student of Ibrahim al-Nakha'i and heir to Kufa's rational and practical legal tradition.^7 Under his guidance, Abu Hanifah spent nearly 18 years learning the foundations of Islamic law.

Their teacher-student relationship was very intensive. Abu Hanifah often slept in the mosque after spending the day discussing various legal problems with Hammad. Hammad taught a flexible method of *istinbath* (legal derivation), prioritizing wisdom and public interest in establishing laws. This approach greatly influenced Abu Hanifah's view of Islamic law as a system that must be able to answer the challenges of the times.^8

**Abu Hanifah once said**: *"I sat with Hammad for ten years, and in the following ten years, I found no one who could match the depth of his knowledge in qiyas and ra'yu."* This statement shows Abu Hanifah's deep appreciation for the rational method taught by his teacher.^9

### Methodology of Qiyas and Istihsan: Foundation of Legal Thought

Abu Hanifah developed a systematic and rational legal methodology, with *qiyas* and *istihsan* as its main pillars. He used *qiyas* (analogy) extensively to solve new legal problems that had no explicit text in the Quran and Hadith.^10

**Abu Hanifah's Qiyas Method** had four elements: (1) *al-asl* (the base case with existing text), (2) *al-far'* (the new case to be determined), (3) *al-'illah* (the legal cause that connects them), and (4) *al-hukm* (the law to be applied). An example of its application is the prohibition of *nabidh* (fermented date drink) based on analogy to grape wine, with the same 'illah: intoxication.^11

**Istihsan**, a concept that became characteristic of the Hanafi school, is "abandoning obvious qiyas for hidden qiyas due to stronger evidence." Abu Hanifah defined it as *"al-'udul 'an muqtada al-qiyas ila ma huwa aslah minhu"* (turning from the demands of qiyas to what is more appropriate). Istihsan does not mean following desires, but choosing legal solutions closer to the maqashid shari'ah (objectives of law).^12

An example of istihsan application is the law of **istishna'** (contract for ordering non-existent goods). According to qiyas, this contract is forbidden because it includes selling non-existent goods (*bay' ma'dum*). However, Abu Hanifah applied istihsan by permitting it based on societal need (*hajah*) and long-established practice (*'urf*).^13

Abu Hanifah's *ra'yu* (reasoning) approach was not arbitrary but based on strict principles. He prioritized: (1) the Quran, (2) authentic Hadith, (3) consensus of companions, (4) analogy based on texts, (5) istihsan (choosing the better opinion), and (6) *'urf* (customs not contrary to sharia).^14
...
**Balance between reason and revelation**: Abu Hanifah showed that using reason in understanding religion does not mean ignoring texts, but rather a way to capture the spirit and purpose of sharia more deeply. The qiyas and istihsan methodology he developed proves that sound reasoning can be a tool for understanding Allah's will, not replacing it.

**Independence of scholars from power**: Abu Hanifah's attitude in refusing the position of judge teaches the importance of maintaining scholarly intellectual independence from political pressure. Scholars must dare to say no to rulers when principles are at stake. The sacrifice of life in prison shows the price that must be paid to maintain scientific integrity.

**Flexibility in ijtihad**: Abu Hanifah's methodology proves that Islam can answer the challenges of the times while adhering to its basic principles. Flexibility in *furu'* (branches) allows the universality of Islam's message. The pragmatic approach that does not abandon spiritual idealism became a model for Islamic law development to this day.

**Collaborative and democratic**: Abu Hanifah's teaching method involving students in active discussion shows that knowledge development cannot be done individually. The richness of the Hanafi school was born from intensive intellectual dialogue between teacher and students, creating an open and dynamic scholarly tradition.

---

## Bibliography

1. Al-Khatib al-Baghdadi, *Tarikh Baghdad*, vol. 13.
2. Al-Dhahabi, Shams al-Din, *Siyar A'lam al-Nubala'*, vol. 6.
3. Abu Zahrah, Muhammad, *Abu Hanifah: Hayatuhu wa Asruhu*, Cairo: Dar al-Fikr al-Arabi, 1947.
4. Al-Makki, Muhammad al-Khuwarizmi, *Jami' Masanid Abi Hanifah*, vol. 1.
...
7. Al-Sarakhsi, Shams al-Din, *Usul al-Sarakhsi*, vol. 2.
8. Schacht, Joseph, *The Origins of Muhammadan Jurisprudence*, Oxford: Clarendon Press, 1950.
9. Al-Qurashi, Muhyi al-Din, *Al-Jawahir al-Mudiyyah fi Tabaqat al-Hanafiyyah*, vol. 1.
