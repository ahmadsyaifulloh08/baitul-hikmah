...
> Yang BOLEH: cahaya/nur keemasan (bukan bentuk manusia), simbol (bintang, sinar), objek (tongkat, sandal — tanpa sosok).

> **Style**: Warm watercolor storybook, children age 6-12, **16:9 landscape (1792×1024)**, soft edges, stylized (not photorealistic). Arabian 6th century. Sandy gold, warm beige, dusty earth.
> **RATIO**: Wajib 16:9 landscape. Prompt HARUS include: `"Image ratio: exactly 16:9 landscape (wide). Resolution: 1792x1024 or similar."`
> **SETIAP slide = gambar UNIK** — tidak boleh ada duplikat.
> **NO TEXT**: Gambar TIDAK BOLEH mengandung text/huruf/caption/signature apapun.
> **SAFE ZONE**: Semua subjek utama (wajah, kepala, karakter, objek kunci) WAJIB di CENTER 70% area gambar. Edge/pinggir harus bersih dari elemen penting — akan ter-crop di berbagai ukuran layar. Gambar ditampilkan fullscreen `object-fit: cover`.
> **CAHAYA MUHAMMAD ﷺ (KONSISTEN)**: Kehadiran Nabi Muhammad ﷺ direpresentasikan sebagai **cahaya emas bersinar (golden radiant glow)** — lingkaran cahaya emas yang bersinar ke segala arah dengan sinar-sinar lembut (rays). Warna: warm golden-white. Ukuran: proporsional dengan scene (~15-20% tinggi gambar). WAJIB konsisten di SEMUA slide — bentuk, warna, ukuran sama. Tidak boleh variasi (column, ribbon, burst, starburst dll) — SELALU golden circular glow with rays.
> **NO BLACK BORDERS**: Gambar HARUS mengisi canvas 100% edge-to-edge. Tidak boleh ada black bars, letterbox, atau padding kosong.

## Character Consistency Reference
- **Abrahah**: Yemeni king, ornate red/gold robe, short dark beard, golden crown, arrogant posture
- **Gajah Mahmud**: Largest war elephant, dark gray, red war saddle with gold cloth, much bigger than other elephants
- **Abdul Muthalib**: Elderly dignified Arab leader, white beard, clean white robe, calm noble posture
- **Halimah**: Bedouin woman, simple brown/cream clothing, head covering, kind gentle appearance
...
## E01 — Tahun Gajah (12 slides)

### e01-slide-01 — Abrahah membangun gereja al-Qullays
Abrahah (red/gold robe, golden crown) standing proudly in front of the grand al-Qullays church in Sana'a, Yemen. Massive pillars, gold ornaments, domed roof. Mountains of Sana'a in background. Mood: proud but hollow.

### e01-slide-02 — Orang Arab tetap pergi ke Ka'bah
Split composition: LEFT side shows the grand al-Qullays church (empty, no visitors). RIGHT side shows streams of Arab travelers on camels heading toward a distant Ka'bah (simple cube) in golden light. Contrast between ignored grandeur and beloved simplicity.

### e01-slide-03 — Pasukan gajah bersiap berangkat
Military camp in Yemen. Abrahah on a raised platform giving orders. Rows of war elephants being prepared — handlers strapping war saddles. Mahmud (the biggest elephant) stands front and center, towering over others. Soldiers lining up. Mood: menacing preparation.

### e01-slide-04 — Pasukan berjalan melintasi padang pasir
Long marching column crossing desert LEFT TO RIGHT (toward Makkah). Mahmud leads at front, trunk raised. Behind him: smaller elephants, cavalry, infantry with banners. Dust clouds rising. Hijaz hills in distance. Tiny silhouette of Makkah far right on horizon. Mood: overwhelming military power.

### e01-slide-05 — Pasukan mengambil unta di dekat Makkah
Soldiers seizing 200 camels from a grazing field near Makkah. Camels being herded away by soldiers. In the background, the outskirts of Makkah visible. A few Arab herders watch helplessly. Mood: aggression, theft.

### e01-slide-06 — Abdul Muthalib menemui Abrahah di tenda
Inside ornate military tent. Abdul Muthalib (white robe, white beard, standing tall and calm) faces Abrahah (seated on throne, surrounded by guards, looking surprised/confused). Between them: tension. Through tent opening: camels visible outside. Mood: dignity vs power.

### e01-slide-07 — "Ka'bah punya Tuhan yang akan melindunginya"
Close-up moment: Abdul Muthalib's hand raised in a calm gesture of certainty. Abrahah leaning forward in disbelief. Light coming through tent opening illuminating Abdul Muthalib. Mood: unshakeable faith. (Different angle/composition from slide 06)

### e01-slide-08 — Gajah Mahmud berlutut menolak maju
Mahmud the elephant KNEELING on the ground, front legs folded, head bowed LOW. He FACES TOWARD Ka'bah (visible in the distance ahead of him) but REFUSES to move. Handler on top whipping desperately but elephant won't budge. Other elephants behind also stopping, confused. Mood: divine intervention.
⚠️ CRITICAL: Elephant faces TOWARD Ka'bah but kneels/refuses. Ka'bah is AHEAD of elephant, not behind.

### e01-slide-09 — Burung ababil datang dari langit
Sky FILLED with hundreds of small dark birds (ababil) flying in formation from above. Each bird carries 3 small glowing reddish stones (1 in beak, 1 in each claw). Stones raining down on panicking soldiers below. Dramatic sky — dark storm on one side, golden light over Ka'bah on other side. Mood: divine punishment, awe-inspiring.

### e01-slide-10 — Kehancuran pasukan Abrahah
Aftermath scene: abandoned military equipment scattered on desert ground — broken saddles, torn banners, empty armor. No dead bodies shown (children-friendly). Dust settling. In the distance, Ka'bah stands untouched, bathed in golden light. A few birds still circling in sky. Mood: aftermath, Ka'bah protected.

### e01-slide-11 — Malam kelahiran Nabi Muhammad ﷺ
Night scene in Makkah. A simple stone house with WARM GOLDEN LIGHT emanating from within — glowing through windows and door, spreading outward. Night sky filled with extraordinarily bright stars, one brilliant star directly above the house. Crescent moon. Silhouette of Makkah rooftops, Ka'bah faintly visible. A few women (from behind) walking toward the house.
⚠️ NO baby, NO human figure representing the Prophet. Only LIGHT from inside the house.

### e01-slide-12 — Tahun Gajah sebagai penanda waktu
Symbolic/artistic composition: Ka'bah at center, protected by a dome of golden light. Around it: remnants of broken elephant armor (past), bright star above (birth), and radiating timeline markers spreading outward. Desert landscape stretching to horizon. Dawn sky. Mood: significance, legacy, hope.

---

## E02 — Yatim Piatu (16 slides)

### e02-slide-01 — Abdullah wafat di Yatsrib (Madinah)
A simple fresh grave mound with plain stone marker in an oasis of Yatsrib. Date palms casting long shadows (late afternoon). A few travelers' belongings (merchant bags, water flask) left near the grave. Golden-orange sunset sky, melancholic. Buildings of ancient Yatsrib in background. Mood: sad but peaceful.

### e02-slide-02 — Harta peninggalan Abdullah
Still-life scene: five camels, a few goats, and a small bundle of belongings arranged in a simple courtyard in Makkah. Morning light. Empty — the owner is gone. A woman's shadow (Ummu Aiman) falls across the ground near the animals. Simple, sparse. Mood: modest inheritance, absence.

### e02-slide-03 — Ibu-ibu susu datang ke Makkah
Market/gathering scene in Makkah. Several Bedouin women arriving on donkeys/camels, looking at babies held by Meccan mothers. Busy, colorful scene. Women examining, negotiating. Focus on the social activity. Mood: lively tradition.

### e02-slide-04 — Halimah tidak mendapat bayi
Halimah (brown/cream clothing, kind face) sitting alone on the edge of the gathering, looking dejected. Other Bedouin women walking away with babies. Her thin donkey and skinny goat nearby. Dry, barren look to her belongings. Late afternoon. Mood: disappointment, poverty.

### e02-slide-05 — Halimah mengambil bayi yatim
Halimah standing near a Meccan house, being handed a bundle of white cloth (baby — NOT visible, just cloth bundle). A WARM GOLDEN GLOW emanates from the bundle. Halimah's expression: surprised, touched. Mood: turning point, quiet miracle.
⚠️ NO baby face/body visible. Just cloth bundle with golden light.

### e02-slide-06 — Keberkahan di Bani Sa'd
Transformation scene: Halimah's camp in the desert, but everything is LUSH and GREEN (unusual for desert). Fat healthy goats grazing on green grass. Full milk containers. Halimah's tent looks better maintained. A warm golden glow emanates from near the tent (presence of Muhammad — NO physical form). Other Bani Sa'd tents in background look dry/normal by comparison. Mood: miraculous blessing, abundance.

### e02-slide-07 — Kolom cahaya di padang Bani Sa'd (Syaqq al-Shadr)
A brilliant COLUMN OF WHITE-GOLDEN LIGHT rising from the ground up to the sky in an open field. NO human figure inside or near the light — pure nur. Two luminous silhouettes (angels — no facial features, just glowing white forms) kneeling on either side of the light column. Sheep/goats in distance looking toward the light. Children (playmates) running away toward tents in far background. Sky opening above with bright blue circle of clear sky. Mood: supernatural, sacred, awe-inspiring.
⚠️ NO physical form of Muhammad. Pure light column only.

### e02-slide-08 — Halimah khawatir, membawa kembali ke Makkah
Halimah on a donkey traveling along a desert road from Bani Sa'd toward Makkah (city visible ahead). She carries a bundle with golden glow (Muhammad — no physical form). Her expression: worried, protective. Desert road stretching behind her. Mood: concern, maternal protection.

### e02-slide-09 — Aminah mengajak ke Madinah
A small caravan (2-3 camels) setting out from Makkah. Aminah (young woman, modest dress) riding a camel with a covered howdah/sedan. A small golden light sits beside her in the howdah (Muhammad's presence — NO physical child). Ummu Aiman walking alongside. Road ahead stretches toward distant hills. Morning light, hopeful departure. Mood: mother-son journey, bittersweet.

### e02-slide-10 — Aminah wafat di al-Abwa'
Desert roadside between Makkah and Madinah. A camel sedan/howdah stopped. Ummu Aiman (from behind) kneeling beside the sedan, head bowed in grief. A SMALL GOLDEN LIGHT stands alone in the vast empty desert — dim but not extinguished. A pair of small sandals on the ground near the light. Purple/orange melancholic sunset sky. Distant road stretching both ways — nowhere feels like home. Mood: deep sadness, loneliness, but not hopeless.
⚠️ NO child figure. Only small golden light + sandals to represent Muhammad.

### e02-slide-11 — Ummu Aiman membawa kembali ke Makkah
Ummu Aiman (dark-skinned, protective posture) walking on foot along a desert road toward Makkah (visible ahead). She leads a camel. A warm golden glow travels beside her (Muhammad's presence). Stars beginning to appear in dusky sky. Her shadow stretches long. She looks determined despite exhaustion. Mood: devotion, protection, resilience.

### e02-slide-12 — Abdul Muthalib dan cahaya Muhammad di Ka'bah
Abdul Muthalib (elderly, white beard, white robe) sitting on a carpet/mat near Ka'bah courtyard. Other Quraish leaders sitting in a circle, some smiling warmly toward Abdul Muthalib. A WARM GOLDEN LIGHT sits close beside Abdul Muthalib — he has one hand gently extended toward it. Ka'bah wall visible in background. Afternoon light. Mood: love, warmth, grandfather's devotion.
⚠️ NO child figure. Golden light beside grandfather.

### e02-slide-13 — Wafatnya Abdul Muthalib
An elderly man's hand (Abdul Muthalib) reaching out from a bed/mat, pointing toward a younger man (Abu Thalib — brown robe, kind face) who stands nearby with hand on heart accepting responsibility. A small golden light between them — being entrusted. Simple Meccan room, oil lamp, muted colors. Mood: passing of guardianship, solemn trust.

### e02-slide-14 — Abu Thalib merawat dengan kasih sayang
Simple modest home interior. Abu Thalib (brown/beige robe, kind face, not wealthy) sitting with his own children at a modest meal — bread, dates, milk. A golden warm light among them (Muhammad's presence). The light seems to make the modest meal glow warmer. Abu Thalib smiling toward the light. His children around, cozy family scene. Mood: love despite poverty, warmth.

### e02-slide-15 — Menggembala kambing di perbukitan
Hilltop overlooking Makkah valley. A shepherd's staff planted in the ground with GOLDEN LIGHT emanating around it (Muhammad's presence — NO human figure). A flock of 15-20 sheep/goats grazing peacefully in the valley below. One baby goat standing close to the staff/light, looking comfortable. Golden morning hour light from behind. Small bag of provisions on the ground. Makkah city small in the distance below. Mood: peaceful, humble, independent.
⚠️ NO human figure. Shepherd's staff + golden light only.
