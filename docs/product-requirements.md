...
### Segmen B: Anak-Anak (Mode Dongeng)
- **Profil**: Anak usia 5-12 tahun (dibacakan orang tua sebagai dongeng malam)
- **Kebutuhan**: Visual menarik, cerita sederhana, tokoh yang relatable, motivasi + nilai Islam
- **Tone**: Fun, inspiratif, warm — seperti storytelling
...
- **Format**: **Popup slideshow presentation** (fullscreen/modal) — bukan halaman artikel biasa
  ...
  - Total per event: ~8-16 slide (4 section × 2-3 slide)
